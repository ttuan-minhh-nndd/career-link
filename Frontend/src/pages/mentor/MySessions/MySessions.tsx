...
const mockSessions: Session[] = [
  {
    ...
    menteeRole: "Sinh viên năm 3 CNTT",
    menteeAvatar:
  ...
  {
    id: 2,
    menteeName: "Đỗ Thị Như Ý",
    menteeRole: "Fresher Backend Developer",
    menteeAvatar:
  ...
  {
    id: 3,
    menteeName: "Trần Kim Ngân",
    menteeRole: "Sinh viên Data Science",
    menteeAvatar:
...
export default function MentorMySessions() {
  ...
  return (
    <main className="bg-slate-50 min-h-screen">
      {/* Nếu bạn có NavHeader chung cho mentor thì bật lại: */}
      {/* <MentorNavHeader /> */}
        ...
        <div className="mb-6 lg:mb-8 flex flex-col gap-2 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-xl text-sm text-slate-600">
              Quản lý các buổi mentoring 1:1 mà bạn phụ trách: xem lịch sắp tới,
              lịch sử buổi hẹn và các buổi đã hủy với mentee.
            </p>
          </div>
    ...
    <article className="overflow-hidden rounded-3xl bg-white shadow-sm ring-1 ring-slate-200">
      <div className="flex flex-col gap-4 p-5 lg:flex-row lg:items-center lg:gap-6 lg:p-6">
        ...
        <div className="flex flex-1 items-center gap-4">
          ...
          <div>
            ...
            <p className="text-xs text-slate-600">{menteeRole}</p>
      ...
      <div className="flex flex-col gap-3 border-t border-slate-200 bg-slate-50/70 px-5 py-3.5 text-xs lg:flex-row lg:items-center lg:justify-between lg:px-6">
        <p className="text-slate-600">
          Gợi ý: Bạn có thể chuẩn bị trước tài liệu hoặc ví dụ thực tế để buổi
          mentoring hiệu quả hơn.
        </p>
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-3xl bg-white py-14 text-center shadow-sm ring-1 ring-slate-200">
      ...
      <h2 className="text-base font-semibold text-slate-900">
        Bạn chưa có buổi mentoring nào
      </h2>
      <p className="mt-2 max-w-sm text-sm text-slate-600">
        Khi mentee đặt lịch với bạn, các buổi mentoring sẽ hiển thị tại đây.
        Hãy đảm bảo profile của bạn nổi bật và đầy đủ thông tin.
      </p>
      <Link
        to="/mentor/profile"
