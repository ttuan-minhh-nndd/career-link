      ...
      <div className="mx-auto grid min-h-screen max-w-7xl place-items-center px-4 py-10">
        <div className="w-full max-w-md">
          ...
          <div className="mb-6 text-center">
            ...
            <h1 className="text-xl font-bold tracking-tight text-slate-900 dark:text-slate-100">Tạo tài khoản</h1>
            <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">Chọn vai trò để đồng bộ trải nghiệm</p>
          </div>
          ...
          <div className="rounded-3xl bg-white/90 p-6 shadow-xl ring-1 ring-slate-100 backdrop-blur supports-[backdrop-filter]:bg-white/70 dark:bg-slate-900/60 dark:ring-white/10">
            <form className="space-y-4" noValidate>
              ...
              <div className="flex items-center justify-between gap-3">
                <label className="text-sm font-medium text-slate-700 dark:text-slate-200">Đăng ký với vai trò</label>
            ...
            <p className="mt-5 text-center text-sm text-slate-600 dark:text-slate-400">
              Đã có tài khoản?{" "}
              <Link className="font-semibold text-sky-700 hover:underline dark:text-sky-400" to={path.login}>
                Đăng nhập
              </Link>
            </p>
          </div>
